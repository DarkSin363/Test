...
function sendUserData() {
    ...
    fetch('https://localhost:8080/user-init', {
        method: 'POST',
...
function buySneakers() {
    ...
    fetch('https://localhost:8080/create-payment', {
        method: 'POST',
...
async function refundLastPurchase() {
    try {
        ...
        const response = await fetch('https://localhost:8080/refund', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
function updatePurchaseCount() {
    fetch('https://localhost:8080/get-purchase-count')
...
async function updatePurchaseCount() {
    ...
    try {
        const response = await fetch('https://localhost:8080/get-purchase-count');
